...
impl ActivityBarView {
    ...
    pub fn icon(&self) -> aether_ui::icons::IconKind {
        match self {
            ActivityBarView::Explorer => aether_ui::icons::IconKind::Folder,
            ActivityBarView::SourceControl => aether_ui::icons::IconKind::GitBranch,
            ActivityBarView::Terminal => aether_ui::icons::IconKind::Terminal,
            ActivityBarView::RemoteManager => aether_ui::icons::IconKind::Ssh,
            ActivityBarView::AiAssistant => aether_ui::icons::IconKind::Bot,
        }
    }
...
mod tests {
    ...
    fn test_activity_bar_view_label_icon_key() {
        ...
        assert_eq!(
            ...
            aether_ui::icons::IconKind::Terminal
        );
